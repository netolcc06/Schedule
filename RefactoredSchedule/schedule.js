...
function  parseRule(rule, ruleId){
    ...
    for(var i = 0; i< days.length; i++){
        ...
        //     case '2':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, monday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case '3':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, tuesday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case '4':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, wednesday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case '5':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, thursday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case '6':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, friday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case 'S':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, saturday, interval.rule, interval.regular)
        //         })
        //         break;
        //     case 'D':
        //         intervals.forEach(interval =>{
        //             addNodeInList(interval.start,interval.end, sunday, interval.rule, interval.regular)
        //         })
        //         break;
        //     default:
        //         break;
...
function toJson(firstDate, lastDate){
    ...
    itDate.getFullYear() === endDate.getFullYear())){
          ...
          //text += JSON.stringify(printList(getListByDate(itDate.getDay()), fullDateString))
          // var curr_list = getListByDate(itDate.getDay())
          // if(curr_list!= undefined){
          //if(getListByDate(itDate.getDay().length!=0))
          jsons.push(printList(getListByDate(itDate.getDay()), fullDateString))
          //console.log("WWWWWWWWWWWWWWHHHHHHHHHYYYYYYYYYYYY" + "length === "+curr_list.length)
          ...
          //console.log('************************************')
          //console.log(printList(curr_list, fullDateString))
          //}
...
parseRule("*23456SD@14h30:17h00@18h00:19h41", 0)
parseRule("*246@08h30:9h00@10h00:10h30", 1);
parseRule("#26/3/2019@12h00:13h00", 2);
parseRule("*23456SD@14h40:17h00@17h20:19h40", 3)
...
console.log('*************************************************************************')
// console.log(toJson('20-03-2019','29-03-2019'))
// console.log('*************************************************************************')
// console.log(JSON.stringify(toJson('20-03-2019','29-03-2019')))
// console.log(monday)
// console.log(tuesday)
